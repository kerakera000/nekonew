...
<main class="main-layout">
    ...
    <section class="neko-model layout-content">
        <div class="inner-content neko-model__inner">
            <h1 class="neko-model__title">ねこモデルについて</h1>

            <p class="neko-model__lead">
                ねこカフェいちごのねこスタッフたちが、ねこ用品の宣伝や広告（その他も要相談）で撮影協力をさせていただきます。
            </p>
            ...
            <div class="neko-model__detail">
                <section class="neko-model__text-block">
                    ...
                    <ul class="neko-model__list">
                        <li>撮影場所は店舗にて行います。プロカメラマンや依頼者による撮影の場合は基本的には定休日の木曜日に承ります。</li>
                        <li>依頼者様のご意向で、営業日での撮影をご希望の場合は、時間料金を別途1時間33,000円いただいております。</li>
                ...
                <section class="neko-model__text-block">
                    ...
                    <ul class="neko-model__list">
                        <li>フラッシュでの撮影はお止めいただいております。</li>
                        <li>当店の猫たち以外の動物の入店はできません。</li>
                        <li>大きい音は出さないようお願いいたします。</li>
                        <li>好きなねこスタッフを選べますが、それぞれの性格や体調により、ご要望にお応えできない可能性があります。あらかじめご了承ください。</li>
                        <li>撮影で起用できる仔猫は2ヶ月齢からとなります。</li>
                        <li>仔猫がいない場合もありますので、あらかじめご了承ください。</li>
                    </ul>
                </section>
            </div>
