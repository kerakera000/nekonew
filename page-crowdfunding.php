    ...
    <section class="Crowdfunding layout-content">
        <div class="inner-content Crowdfunding__inner">
            ...
            <div class="Crowdfunding__body">
                ...
                <p>今回、クラウドファンディングの目標達成には至りませんでしたが、ご協力いただいた皆様のお気持ちに応えられるよう、今いる保護猫たちのケアやこれからの事業拡大に向けて、スタッフ一同よりいっそう精進し取り組んで参ります。</p>
            ...
            <div class="Crowdfunding__supporters">
                ...
                <p class="Crowdfunding__supporters-text">
                    イトウユリコ様　よっしー様　ぴーちゃん様<br>
                    むらっち様【去勢・避妊手術サポーター】<br>
                </p>
